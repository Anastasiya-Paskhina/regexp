...
lfs_names = "([А-ЯЁ]{1}[а-яё]+)(\s)([А-ЯЁ]{1}[а-яё]+)(\s)([А-ЯЁ]{1}[а-яё]+)"
lfs_names1 = "([А-ЯЁ]{1}[а-яё]+)(\s)([А-ЯЁ]{1}[а-яё]+)"
...
for contact in contacts_list:
    ...
    if re.match(lfs_names, contact[0]):
        result = re.match(lfs_names, contact[0])
        contact[0] = result.group(1)
        contact[1] = result.group(3)
        contact[2] = result.group(5)

    if re.match(lfs_names1, contact[0]):
        result = re.match(lfs_names1, contact[0])
        contact[0] = result.group(1)
        contact[1] = result.group(3)

    if re.match(lfs_names1, contact[1]):
        result = re.match(lfs_names1, contact[1])
